...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <style>
    /* 1. Cambia el cursor y prepara el brillo */
    .container .glass {
        cursor: pointer;
        /* Sale el icono de la mano (dar click) */
        transition: 0.5s;
    }

    /* 2. Efecto cuando el ratón pasa por encima (iluminación) */
    .container .glass:hover {
        ...
        /* Se aclara el fondo */
        /* Resplandor neón usando tu variable verde */
        box-shadow: 0 0 25px var(--verde1), 0 10px 30px rgba(0, 0, 0, 0.5);
        border: 1px solid var(--verde1);
    }

    /* 3. Ilumina el icono SVG al pasar el ratón */
    .container .glass:hover svg {
        fill: var(--verde1);
        /* El icono se vuelve verde lima */
        transform: scale(1.2);
        /* Crece un poco */
    ...
    /* 4. Cambia el color del texto inferior al pasar el ratón */
    .container .glass:hover::before {
        color: var(--verde1);
        background: rgba(154, 255, 77, 0.1);
    }
